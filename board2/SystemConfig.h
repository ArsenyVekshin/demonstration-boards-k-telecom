...
#define TEMP_CORECT_RES 100000 	//Сопротивление термопары
#define RESIST_BASE 102000 		//сопротивление резистора делителя
#define B_COEF 3950 			//коофицент В (даташит)
#define TEMP_BASE 25 			//температура "обычного" сопротивления (даташит)
...
#define TEMPERATURE 1 	//тип датчика "датчик температуры"
